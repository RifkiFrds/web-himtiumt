...
export const Input = forwardRef(
  ({
    ...
    const [formatedValue, setFormatedValue] = useState(rest.value || "");
    return (
...
Input.propTypes = {
  ...
  borderColor: PropTypes.oneOf(["black", "normal"]),
  placeholderColor: PropTypes.oneOf(["black", "normal"]),
  errorText: PropTypes.string,
  inputStyle: PropTypes.oneOf(["addons", "icon"]),
