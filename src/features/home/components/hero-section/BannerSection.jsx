  ...
  const bannerContent = (
    ...
    <div className="flex items-center gap-2">
        ...
        <Poppins className="text-sm leading-6 opacity-80">
            Segera hadir di Universitas Muhammadiyah Tangerang. Jangan sampai ketinggalan!
        </Poppins>
      </div>
        
        <div className="flex items-center gap-x-6 text-sm">
            <span className="flex items-center gap-2"><Tv size={16} /> Seminar</span>
            <span className="flex items-center gap-2"><Palette size={16} /> Lomba UI/UX</span>
            <span className="flex items-center gap-2"><Trophy size={16} />Lomba Futsal</span>
            <span className="flex items-center gap-2"><Gamepad2 size={16} />Lomba Mobile Legends</span>
